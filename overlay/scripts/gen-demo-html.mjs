...
const DEMO_HEAD = `
    ...
    <style>
      ...
      #demo-links a:hover, #demo-links button:hover { background: rgba(255, 255, 255, 0.1); color: #fff; }
      #demo-links .primary { background: #cc785c; color: #fff; }
      #demo-links .primary:hover { background: #d98a70; color: #fff; }
...
const DEMO_BODY = `
    ...
    <div id="demo-links">
      <button type="button" id="demo-tour-btn" class="primary">
        <svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M4.5 2.8a1 1 0 011.52-.86l7.2 4.4a1 1 0 010 1.72l-7.2 4.4a1 1 0 01-1.52-.86V2.8z"/></svg>
