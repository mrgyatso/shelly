#!/usr/bin/env node
// shelly-charset.cjs — guarantee an artifact carries the `<meta charset="utf-8">` label.
//
...
// (called from shelly-index.cjs on every artifact `Write|Edit`). Deterministic, like the
